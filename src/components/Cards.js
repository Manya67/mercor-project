...
const Cards = () => {
  ...
  const handleDragEnd = (result) => {
    ...
    const sourceSection = CardData[sourceSectionIndex];
    ...
    const destinationSection = CardData[destinationSectionIndex];
  ...
  return (
    <DragDropContext onDragEnd={handleDragEnd}>
      <section className="mt-10 grid gap-5 lg:grid-cols-3 ">
        {CardData.map((item, sectionIndex) => {
          const { id, title: cardHead, identityColor, tasks } = item;
          return (
            <div key={id} className="rounded-2xl bg-[#F5F5F5] p-5">
              ...
              <hr
                style={{ borderColor: `${identityColor}` }}
                className={`mt-5 border-2 border-[#${identityColor}]`}
              />
                        ...
                        >
                          {(provided) => (
                            <article
                              ...
                              className={`my-5 rounded-2xl bg-white p-5 md:p-8   `}
                            >
